...
template<typename T, typename BASE = typename any_vec<T>::BASE>
struct VElement
{
  static constexpr BASE& get(T &v, unsigned int i)
  {
...
template<typename T, int N=any_vec<T>::N>
